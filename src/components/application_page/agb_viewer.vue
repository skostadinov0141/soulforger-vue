...
<template>
    <div class="agb-container">
        <div class="agb-active-container">
            ...
            <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Simeon Kostadinov<br />
            Am K&ouml;nigsberg 4<br />
            29525 Uelzen</p>

            <p>Telefon: +49 176 63213726<br />
            E-Mail: soulforger.net@gmail.com</p>
...
<style scoped>
    ...
    .agb-container{
        ...
        padding: 16px;
        border-radius: 5px;
        color: rgb(var(--text-shade-1));
        background-color: rgb(var(--bg-shade-0));
        font-family: Roboto;
        font-size: 14px;
        font-weight: 300;
